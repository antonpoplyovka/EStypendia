...
INSERT into student (name, surname, father_name, email, place_of_birth, country_of_birth, nationality,
                     nationality_of_birth, address_of_residence, actual_address, address_type, type_of_student)
values ('Adam', 'Nowak', 'Jan', 'inf201621@gmail.com', 'Lublin', 'Polska', 'Polak', 'Polak',1,1,1,1);
INSERT into student (name, surname, father_name, email, place_of_birth, country_of_birth, nationality,
                     nationality_of_birth, address_of_residence, actual_address, address_type, type_of_student)
values ('Jan', 'Kowalski', 'Adam', 'some-email@gmail.com', 'London', 'UK', 'Polak', 'UK',1,3,2,2);
INSERT into student (name, surname, father_name, email, place_of_birth, country_of_birth, nationality,
                     nationality_of_birth, address_of_residence, actual_address, address_type, type_of_student)
values ('Bin', 'Tomczyk', 'Jerzy', 'some-email@gmail.com', 'Warszawa', 'Polska', 'Polak', 'Polak',1,3,2,2);
